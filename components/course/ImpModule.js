                    ...
                    <div className="container px-5 py-8 mx-auto">
                        <div className="flex flex-wrap -m-2">
                            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
                                <div className="h-full flex items-center bg-[#D14B39] p-4 rounded-md ">
                                    <div>
                            ...
                            {resources.map((resource) => (
                                <div key={resource.title}>
                                    <div className="flex flex-col md:flex-row text-lg font-medium text-left md:mx-16">
                                        {/* <div className="md:w-1/4 border-y-2 border-white bg-[#D14B39] px-5 flex items-center py-1 md:py-5 rounded-t-sm">
                    ✔ {resource.title}
                  </div> */}
                                        <div className="md:w-full bg-white text-gray-900 mb-5">
                                            <div className="bg-[#D14B39] flex justify-between  items-center text-white px-3 md:px-8 py-3 text-xl md:text-2xl font-semibold">
